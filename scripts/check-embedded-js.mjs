...
for (const s of ['check-patches.mjs', 'check-resolve-detection.mjs', 'check-turn-close-detection.mjs', 'check-resolve-corpus-bank.mjs', 'check-resolve-corpus.mjs', 'check-resolve-rerun.mjs', 'check-stalled-rederive.mjs']) {
